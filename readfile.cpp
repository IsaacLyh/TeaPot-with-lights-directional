          ...
          if (numused == numLights) { // No more Lights 
            ...
            if (validinput) {
              ...
              // Those arrays can then be used in display too.
                    //set up position for lights
                    GLfloat _values[4];
                _values[0] = values[0];
                _values[1] = values[1];
                _values[2] = values[2];
                _values[3] = values[3];
                matransform(transfstack,_values);
                    lightposn[numused*4] = _values[0];
                    lightposn[numused*4+1] = _values[1];
                    lightposn[numused*4+2] = _values[2];
                    lightposn[numused*4+3] = _values[3];
                
                //set up color for lights
